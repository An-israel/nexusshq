...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      workspace_settings: {
        Row: {
          ...
          standup_days: string[];
          standup_due_time: string;
          standup_late_time: string;
          standup_reminder_time: string;
          timezone: string;
          updated_at: string;
          updated_by: string | null;
    ...
    Enums: {
      ...
      deliverable_status: "submitted" | "approved" | "rejected" | "revision_requested";
      department_type:
        | "management"
        | "customer_success"
        | "growth"
