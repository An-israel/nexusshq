...
const COLUMNS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Performance Scoring", href: "#" },
      { label: "Payslips & HR", href: "#" },
      { label: "Team Messaging", href: "#" },
      { label: "Deliverable Approvals", href: "#" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "For Operations Teams", href: "#" },
      { label: "For Remote Teams", href: "#" },
      { label: "For HR Managers", href: "#" },
      { label: "For CEOs & Founders", href: "#" },
        ...
        <div className="absolute bottom-full mb-1 left-0 w-40 bg-[#111111] border border-[#1E1E1E] rounded-xl shadow-2xl overflow-hidden">
          {[
            ...
            <a
              key={label}
              href={href}
              className="block px-4 py-2.5 text-[13px] text-gray-400 hover:text-white hover:bg-white/5 transition-colors"
    ...
    <div className="border-b border-[#1E1E1E]">
      ...
      {open && (
        <div className="pb-4 space-y-2.5">
          {column.links.map(({ label, href, internal }) =>
            internal ? (
              <Link
                key={label}
                to={href as "/terms" | "/privacy" | "/cookies" | "/pricing"}
